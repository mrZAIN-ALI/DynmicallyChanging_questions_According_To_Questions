...
class NewAppState extends State<NewApp> {
  ...
  final  _questionAnswers = [
                  ...
                  "answers":["Blue","Pink","Pink","Red"],
                  },

                  {"question":"What is your Favourte Animal",
                    "answers":["Lion","Women","Beer","Cat"],
                  },
                  {"question":"Which is your Favourte Drik",
                  "answers":["Coke","Juice","Tea","Cofee"],
                  }
  ];
    ...
    return MaterialApp(
      ...
      body: Column(
        children: [
          ...
          ...(_questionAnswers[_index]["answers"] as List<String>).map((answers){
            return Answers(_changeStateAndIndex,answers);
          }).toList()
